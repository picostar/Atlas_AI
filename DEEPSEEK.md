...
If your DeepSeek environment does not auto-load repository instruction files, load this file, `.github/copilot-instructions.md`, and `ATLAS.md` manually at session start.
